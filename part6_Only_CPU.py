...
def inference (best_model1, best_model2, best_model3, test_dataset1, test_dataset2, test_dataset3, DEVICE) : 
    ...
    print("Inferencing the Result using only CPU")
...
cpu, first, done, m, prob = Monitor2 (inference, best_model1, best_model2, best_model3, test_dataset1, test_dataset2, test_dataset3, DEVICE)
...
load_ws = load_wb['result2(Only CPU)']
load_ws.append(record)
load_wb.save(excel)

# Upload the data

upload_file (AD, ID, PS, excel, "soo", "ceph_result_excel") 